          ...
          <div className="flex flex-col md:flex-row items-center justify-around w-full mb-10">
            <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg m-4 md:m-0">
              ...
              <h3 className="text-xl font-bold text-center">
                3 MONTHS or 1200 KM{" "}
                <br className="hidden md:block text-blue-700" /> WARRANTY
              </h3>
            </div>
            ...
            <div className="md:w-1/3 flex flex-col items-stretch justify-center  bg-white p-6 rounded-lg  m-4 md:m-0">
              <ul className="list-none text-left">
                <li className="mb-2 flex items-center">
                  <span className="text-green-500 text-xl mr-2">✔</span>3 Months
                  or 1,200 KM whichever comes first.
                </li>
                <li className="mb-2 flex items-center">
            ...
            <div className="flex justify-center items-center md:w-1/3 m-4 md:m-0 hover:scale-110 transition-transform duration-500 ease-in-out">
              <img
                src={illustration}
                alt="Illustration"
